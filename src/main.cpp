...
int64 nChainStartTime = 1505260800;
...
const string strMessageMagic = "BountyChain signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
        nSubsidy = 300000000 * COIN;	// 1 billion coins, that all pow coins
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BountyChain
    bool fStrictPayToScriptHash = true; // Always active in BountyChain
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BountyChain",CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1505260800;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 13608790 ;
        ...
        assert(block.hashMerkleRoot == uint256("09547776b23b4a4190e5240493f9e86d068cb219c88e2a11230afeb0f36bdb9e"));
